...
class FieldData: 
    ...
    def print_data(self, n=10):
        ...
        print("h={}, rw={}, B={}, phi={}, ct={}, pi={}, mu={}".format(self.h, self.rw, self.B, self.phi, self.ct, self.pi, self.mu))
...
def read_field_data_xlsx(file_path, sheet):
    field_data = FieldData()

    data = pd.ExcelFile(file_path)
    table = data.parse(sheet)
    ...
    field_data.h = table['h'][0]
    field_data.rw = table['rw'][0]
    field_data.phi = table['phi'][0]
    field_data.B = table['B'][0]
    field_data.mu = table['mu'][0]
    field_data.ct = table['ct'][0]
    field_data.pi = table['pi'][0]

    return field_data

if __name__ == "__main__":

    field_data = read_field_data_xlsx('data/GDIS.xlsx', '2')
